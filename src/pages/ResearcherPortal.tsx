    ...
    <>
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="w-60 border-r bg-background">
          <Sidebar
            collapsible="none"
            className="w-full border-0 rounded-none h-full"
          >
          ...
          >
            ...
            <TabsContent value="calendar">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    View deadlines, milestones, and events. For a full calendar,
                        ...
                        <div key={app.id} className="border rounded-lg p-4">
                          <div className="flex justify-between items-start">
                            <div className="space-y-1">
                              ...
                              <div className="text-sm text-muted-foreground">
                                ID: {app.id} • Status: {app.status} • Deadline:{" "}
                                {app.deadline}
                              </div>
                            ...
                            <Badge
                              variant={
                                app.assignedAssistant ? "default" : "secondary"
                              }
                            >
                              {app.assignedAssistant ? "Assigned" : "Available"}
                            </Badge>
                          </div>
                        </div>
                      ))}
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-xs text-muted-foreground mt-1">
                                {assistant.assignedApplications.length} assigned
                              </div>
                            </div>
                          </div>
                        </div>
